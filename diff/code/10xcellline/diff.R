...
sexpr = readRDS(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/result/procimpute/10xcellline/',method,'/hg19.rds'))
example = readRDS(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/result/procimpute/10xcellline/saver/hg19.rds'))
...
colnames(v) = cn
saveRDS(v,paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/diff/result/10xcellline/',method,'.rds'))
