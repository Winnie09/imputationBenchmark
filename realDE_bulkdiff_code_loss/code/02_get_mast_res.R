...
dir.create(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/realDE/result/diff/mast/', mtd,'/res/'), showWarnings = F, recursive = T)
...
for (f in allf){
  ...
  saveRDS(res, paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/realDE/result/diff/mast/', mtd,'/res/',f,'.rds'))  
}
