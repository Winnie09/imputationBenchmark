...
library(parallel)
res <- mclapply(allmtd, funciton(mtd){
      set.seed(12345)
      print(mtd)
      ...
      saveRDS(list(mdata = mdata, tdata = tdata, sdata = sdata, mdata2 = mdata2, sdata2 = sdata2, tdata2=tdata2),
              paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/simu/plot/plot/gene_wilcoxon_statistic_distribution_plotdata/',mtd,'.rds'))   
      return(0)
}, mc.cores=12)
