...
res1$q = factor(sub('.*_','',res1$setting), levels = c('1','2','10'))
...
res2$q = factor(sub('.*_','',res2$setting), levels = c('1','2','10'))
...
pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/simu/plot/plot/diff_roc_boxplot_q.pdf'),width=6,height=7)
