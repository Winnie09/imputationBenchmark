...
pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/simu/plot/',DEMethod,'/plot/sensitivity_p.pdf'),height=3,width=8)
...
dev.off()
pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/simu/plot/',DEMethod,'/plot/sensitivity_q.pdf'),height=3,width=11)
