for (diffmtd in c('wilcox','mast')){
  rdir = paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/realDE/result/hca/overlap/',diffmtd,'/')
  ...
  pdf(paste0('/home-4/whou10@jhu.edu/scratch/Wenpin/rna_imputation/realDE/plot/hca/plot/',diffmtd,'/overlap_hm_moreLessExprGene.pdf'),height=6,width=10)
